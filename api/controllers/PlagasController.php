<?php
require_once './api/models/Plaga.php';
...
class PlagasController {
    ...
    public function getById($id) {
        ...
        if ($result) {
            ...
            echo json_encode(["status" => "error", "message" => "Plaga no encontrado"]);
        }
    }
    ...
    public function create() {
        ...
        if (empty($data['nombre']) || empty($data['descripcion']) || empty($data['fk_TiposPlaga'])) {
